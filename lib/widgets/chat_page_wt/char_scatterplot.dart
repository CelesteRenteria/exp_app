...
@override
  void initState() {
    catAmount = context.read<ExpensesProvider>().eList.map((e) => e.expense)
    .fold(0.0, (a, b) => a+b);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    final cList = context.watch<ExpensesProvider>().allItemsList;
    final currentMonth = context.watch<UIProvider>().selectedMonth + 1;
    final currentDay = dayIntMoth(currentMonth);
    ...
    return Stack(
      ...
      children: [
        Positioned(top: -1, left: 45, child: Text("Día: $catDay")),
        Positioned(
            top: -1,
            right: 40,
