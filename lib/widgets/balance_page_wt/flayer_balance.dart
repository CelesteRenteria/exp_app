            ...
            child: Column(
              ...
              children: [
                ListTile(
                  ...
                  title: const Text('Ingesos'),
                  trailing:
                      Text(getAmountFormat(totalEt), style: const TextStyle(color: Colors.green)),
                ),
                ListTile(
                  dense: true,
                  visualDensity: const VisualDensity(vertical: -4),
                  ...
                  trailing:
                      Text(getAmountFormat(totalExp), style: const TextStyle(color: Colors.red)),
                ),
                const Divider(
                  indent: 15,
                  endIndent: 15,
